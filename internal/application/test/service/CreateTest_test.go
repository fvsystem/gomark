...
func TestCreateTestService_CreateTest(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				...
				handlerResultsReturned:    fakeHandler,
				handlerResultsTransformed: fakeHandler,
			},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			c := tt.c
			c.CreateTest(tt.args.requester, tt.args.numberOfConnections, tt.args.eventEmitter, tt.args.handlerResultsReturned, tt.args.handlerResultsTransformed)
			if !requester.called {
